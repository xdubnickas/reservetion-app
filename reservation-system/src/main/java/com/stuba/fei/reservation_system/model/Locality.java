...
public class Locality {
    ...
    private City city; // References the City entity


//    @OneToMany(mappedBy = "locality")
//    @JsonIgnore
//    private List<Event> events;  // Zoznam udalostí spojených s touto lokalitou
    ...
    private void createDefaultRoom() {
        ...
        defaultRoom.setCapacity(totalCapacity);
